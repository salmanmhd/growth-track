...
import { LayoutDashboard, Brain, CheckSquare, BarChart3, Sun, Moon, Calendar, Settings, Menu, X } from 'lucide-react';
...
function App() {
  ...
  const AppLayout = () => (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Mobile header */}
      <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-white dark:bg-gray-800 px-4 py-4 shadow-sm sm:px-6 md:hidden">
        <button
          type="button"
        ...
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <Routes>
              ...
              <Route path="/negative-thoughts" element={<NegativeThoughtsLogger darkMode={darkMode} />} />
              <Route path="/todos" element={<TodoList darkMode={darkMode} />} />
              <Route path="/weekly-planner" element={<WeeklyPlanner darkMode={darkMode} />} />
              <Route path="/daily-rating" element={<DailyRating darkMode={darkMode} />} />
              <Route path="/performance" element={<PerformanceTracker darkMode={darkMode} />} />
            </Routes>
          </div>
        </div>
      </main>
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark' : ''}`}>
      <Routes>
        ...
        <Route path="/signup" element={<SignUp darkMode={darkMode} onSignUp={handleLogin} />} />
        <Route
          path="/app/*"
          element={
            <ProtectedRoute>
